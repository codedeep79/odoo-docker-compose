...
``` bash
curl -s https://raw.githubusercontent.com/codedeep79/odoo-docker-compose/refs/heads/main/odoo-14-docker-compose/run.sh | sudo bash -s odoo-one 10014 20014
```
...
``` bash
curl -s https://raw.githubusercontent.com/codedeep79/odoo-docker-compose/refs/heads/main/odoo-14-docker-compose/run.sh | sudo bash -s odoo-two 11014 21014
```
